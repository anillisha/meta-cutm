...
DESCRIPTION = "Sample GUI QT helloworld example"
SECTION = "examples"
LICENSE = "MIT"
...
SRC_URI = "file://main.cpp \
           ...
           file://mainwindow.h \
           file://mainwindow.ui \
           file://03-GUI-Programming.pro \
           file://03-GUI-Programming.pro.user"

DEPENDS += "qtbase qtdeclarative qtgraphicaleffects fontconfig"
...
do_install() {
         install -d ${D}${bindir}
         install -m 0755 03-GUI-Programming ${D}${bindir}
}
